...
scatter(xnef,xaltf,'Marker','.'); xlim([0 4000000]); grid on ;box on
  ...
  title(['Electron density profile from Cosmic on ' dd '-' mm  '-' yys ...
         ' doy-' doy1 ' at altitude from 10 to 800 Km']); 
...
figure(2)
   ...
   xlabel('Electron density (N/cm^{3}'); ylabel('Altitude (km)')
  title(['Average Electron density profile from Cosmic on ' dd '-' mm ...
         '-' yys ' doy-' doy1 ' at altitude from 10 to 800 Km'])
...
scatter(xnef2,xaltf2,'Marker','.'); xlim([0 4000000]); grid on ;box on
  xlabel('Electron density (N/cm^{3}'); ylabel('Altitude (km)'); 
  title(['Electron density profile from Cosmic on '  dd  '-'  mm '-' yys ...
         ' doy-' doy1 ' at altitude from ' l_alt ' to ' u_alt ' Km']); 
    set(gcf,'position',get(0,'screensize'));
...
figure(4)
   ...
   xlabel('Electron density (N/cm^{3}'); ylabel('Altitude (km)')
   title(['Average Electron density profile from Cosmic on '  dd  '-' mm ...
         '-' yys ' doy-' doy1 ' at altitude from 200 to 350 Km']);
set(gcf,'position',get(0,'screensize')); grid on ; box on;
...
xlabel('longitude')
ylabel('latitude')
 title(['Electron density map on ' dd '-' mm ...
         '-' yys ' doy-' doy1 ' at altitude from ' l_alt ' to ' u_alt ]);    
set(gcf,'position',get(0,'screensize'));  
